  ...
  <v-container class="bg-gray-6 mt-[60px] flex flex-col gap-10">
    ...
    <section class="py-6">
      ...
      <div class="text-white">
        AI didn’t kill the vibe. It just made the need for realness louder. As
        machines take over tasks, people will crave experience, expression,
        chaos, and connection. That’s where we come in. PartyX isn’t a tech
        product — it’s cultural infrastructure. Built for the post-job world.
        Built for sweat, strobe lights, and shared moments. While others build
        for control, we build for freedom. Our goal? Become the biggest company
        in Europe. Not for profit. But to fund joy and export Berlin’s soul to
        the world.
      </div>
    </section>
    ...
    <section class="py-6">
      <h2 class="text-h4 mb-6 text-light-1 font-cute">Why us?</h2>
    ...
    <section class="py-6">
      <h2 class="text-h4 mb-6 text-light-1 font-cute">Competitive Advantage</h2>
    ...
    <!-- Roadmap & Fund Usage -->
    <section class="py-6">
      <h2 class="text-h4 font-weight-bold mb-6 text-light-1">Use of Funds</h2>
      <v-card class="bg-dark-4 rounded-xl" elevation="10">
        <v-card-text class="pa-6">
            ...
            >
              ...
              <div class="d-flex align-start w-100">
                ...
                >
                  <v-icon size="small">{{
                    /* Chevron logic */
                    expandedIndex === i ? 'mdi-chevron-up' : 'mdi-chevron-down'
                  }}</v-icon>
                </v-btn>
              </div>
            </v-list-item>
      ...
      <v-card class="bg-dark-4 rounded-xl" elevation="10">
        <v-card-text class="pa-6">
          <p class="text-light-2 mb-6">
            Following this €750,000 pre-seed investment, we project a Series A
